    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white pt-24 pb-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8 border-b border-white/10 pb-4">
          <h1 className="text-3xl font-black uppercase tracking-widest text-red-500">VIP Control Panel</h1>
          <p className="text-zinc-500">Manage products, memberships, and content.</p>
        </div>
        {children}
      </div>
    </div>
