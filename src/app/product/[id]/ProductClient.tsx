            ...
            <div className="aspect-[4/3] sm:aspect-[16/10] bg-[#111] rounded-3xl overflow-hidden border border-white/5 relative shadow-2xl flex items-center justify-center">
              {activeMedia ? (
                ...
                <div className="flex flex-col items-center justify-center text-zinc-600">
                  <img src="/logo-2.jpg" alt="GermanGearsIndia" className="w-24 h-24 mb-4 rounded-xl opacity-50 grayscale" />
                  <span className="text-xl font-bold italic opacity-30">GERMANGEARS</span>
                </div>
              )}
            </div>
